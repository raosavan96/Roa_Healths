  ...
  return (
    <>
      <div>
        ...
        <div className="flex flex-col md:flex-row gap-5 justify-between  mb-20">
          <div className="border px-10 py-8 md:px-16 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer">
            <b>Efficiency:</b>
            <p>
